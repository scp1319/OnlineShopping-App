...
public class RetailerService {
	...
	@Transactional
	public void addProducts(String name, String brand, String description, double price, int stock, int retailerId,
	...
	public List<Product> displayProductByRetailerId(int retailerId) {
		return retailerDao.displayProductByRetailerId(retailerId);
	}
